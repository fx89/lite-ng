...
@Component({
  selector: 'lite-ng-toast',
  templateUrl: './toast.component.html',
  styleUrls: ['./toast.component.css']
})
export class LiteNgToastComponent implements AfterViewInit {
  @Input()
  id : string = "_" + uuid();
  ...
  @Input()
  iconPathName : string = <any>undefined;
  ...
  private toastElement : HTMLElement = <any>undefined;
  ...
  showToast() {
    if (this.toastElement == null || this.toastElement == undefined) {
      this.toastElement = <any>document.getElementById(this.getToastFrameId());
    } 
